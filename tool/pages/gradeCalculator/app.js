...
// parameter1 要控制的对象
// parameter2 duration
// parameter3 控制对象的原始数据
// parameter4 控制对象的动画结束后的状态
// parameter5
time_line
...
function handleSorting(direnction) {
  ...
  for (let i = 0; i < graders.length; i++) {
    ...
    let class_grade = graders[i].children[3].value; // class grader
