...
function yr(e, t, n, r, l) {
  ...
  if (((o = 0), (r = r === "" ? "." : r + ":"), Do(e)))
    ...
    for (e = s.call(e), u = 0; !(i = e.next()).done; )
      (i = i.value), (s = r + xl(i, u++)), (o += yr(i, t, n, s, l));
  else if (i === "object")
    throw (
      ((t = String(e)),
      Error(
...
z.StrictMode = a0;
z.Suspense = m0;
z.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED = C0;
...
z.isValidElement = Ai;
z.lazy = function (e) {
  return { $$typeof: v0, _payload: { _status: -1, _result: e }, _init: x0 };
};
z.memo = function (e, t) {
 ...
 */ var S0 = tl,
  ...
  j0 = S0.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner,
...
function bu(e, t, n) {
  ...
  for (r in t) _0.call(t, r) && !L0.hasOwnProperty(r) && (l[r] = t[r]);
  if (e && e.defaultProps)
      ...
      e: for (var W = 0, G = E.length, bn = G >>> 1; W < bn; ) {
        ...
        if (0 > l(wl, P))
          vt < G && 0 > l(er, wl)
            ? ((E[W] = er), (E[vt] = P), (W = vt))
            : ((E[W] = wl), (E[ht] = P), (W = ht));
        else if (vt < G && 0 > l(er, P)) (E[W] = er), (E[vt] = P), (W = vt);
        else break e;
      }
    }
    return L;
...
function gs() {
  if (Qt) {
    var e = Qt,
      t = Zt;
    if (((Zt = Qt = null), Qo(e), t)) for (e = 0; e < t.length; e++) Qo(t[e]);
  }
}
function ys(e, t) {
  return e(t);
...
function $0(e, t, n, r, l, i, o, u, s) {
  (kn = !1), (Tr = null), U0.apply(V0, arguments);
}
function A0(e, t, n, r, l, i, o, u, s) {
  if (($0.apply(this, arguments), kn)) {
    if (kn) {
      var c = Tr;
      (kn = !1), (Tr = null);
...
function ks(e) {
  return (e = B0(e)), e !== null ? Ss(e) : null;
}
function Ss(e) {
...
var Es = ge.unstable_scheduleCallback,
  ...
  W0 = ge.unstable_shouldYield,
  Q0 = ge.unstable_requestPaint,
  Q = ge.unstable_now,
  Z0 = ge.unstable_getCurrentPriorityLevel,
  Xi = ge.unstable_ImmediatePriority,
  Ns = ge.unstable_UserBlockingPriority,
  Rr = ge.unstable_NormalPriority,
  K0 = ge.unstable_LowPriority,
...
var Te = Math.clz32 ? Math.clz32 : J0,
  G0 = Math.log,
  X0 = Math.LN2;
function J0(e) {
  return (e >>>= 0), e === 0 ? 32 : (31 - ((G0(e) / X0) | 0)) | 0;
}
var ir = 64,
  or = 4194304;
function wn(e) {
...
function bi(e, t, n, r) {
  if (Fr) {
    var l = fi(e, t, n, r);
    if (l === null) Fl(e, t, r, Dr, n), Yo(e, r);
    else if (n2(l, e, t, n, r)) r.stopPropagation();
    else if ((Yo(e, r), t & 4 && -1 < t2.indexOf(e))) {
      for (; l !== null; ) {
        var i = Jn(l);
        if (
          (i !== null && Ps(i),
          (i = fi(e, t, n, r)),
          i === null && Fl(e, t, r, Dr, n),
          i === l)
        )
          break;
        l = i;
...
var P2 = We && "TextEvent" in window && !Sn,
  Ds = We && (!ro || (Sn && 8 < Sn && 11 >= Sn)),
  eu = " ",
  tu = !1;
function Is(e, t) {
  switch (e) {
...
function lu() {
  En && (En.detachEvent("onpropertychange", $s), (Dn = En = null));
}
function $s(e) {
  if (e.propertyName === "value" && ll(Dn)) {
    var t = [];
    Us(t, Dn, e, Gi(e)), xs(R2, t);
  }
}
function F2(e, t, n) {
  e === "focusin"
    ? (lu(), (En = t), (Dn = n), En.attachEvent("onpropertychange", $s))
    : e === "focusout" && lu();
}
function D2(e) {
...
var $2 = We && "documentMode" in document && 11 >= document.documentMode,
  Ft = null,
  di = null,
  Nn = null,
  pi = !1;
...
var xn =
  ...
  W2 = new Set("cancel close invalid load scroll toggle".split(" ").concat(xn));
function au(e, t, n) {
  ...
  if (!e[cr]) {
    (e[cr] = !0),
      ls.forEach(function (n) {
        n !== "selectionchange" && (W2.has(n) || Ol(n, !1, e), Ol(n, !0, e));
      });
...
var gi = typeof setTimeout == "function" ? setTimeout : void 0,
  ...
  Y2 =
    typeof queueMicrotask == "function"
      ...
      : typeof du < "u"
      ? function (e) {
          return du.resolve(null).then(e).catch(G2);
        }
      : gi;
function G2(e) {
  setTimeout(function () {
...
function oo(e) {
  for (; e === $r; )
    ($r = Ut[--Vt]), (Ut[Vt] = null), (Ar = Ut[--Vt]), (Ut[Vt] = null);
  for (; e === Nt; )
    (Nt = xe[--Ce]),
      (xe[Ce] = null),
      (Ae = xe[--Ce]),
...
function yo(e, t, n, r, l, i) {
  if (
    ...
    (t.updateQueue = null),
    (t.lanes = 0),
    (Er.current = e === null || e.memoizedState === null ? lc : ic),
    (e = n(r, l)),
    _n)
  ) {
    i = 0;
...
function Ea(e, t, n) {
  return _t & 21
    ? (Re(n, t) || ((n = js()), (V.lanes |= n), (jt |= n), (e.baseState = !0)),
      t)
...
var Yr = {
  ...
  lc = {
    ...
    useTransition: function () {
      var e = Su(!1),
        t = e[0];
      return (e = tc.bind(null, e[1])), (Fe().memoizedState = e), [t, e];
    },
  ...
  return (
    ...
    e !== null && !ce
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ke(e, t, l))
      : (H && n && io(t), (t.flags |= 1), ie(e, t, r, l), t.child)
  );
}
  ...
  return (
    ...
    e !== null && !ce
      ? ((t.updateQueue = e.updateQueue),
        ...
        (e.lanes &= ~l),
        Ke(e, t, l))
      : (H && r && io(t), (t.flags |= 1), ie(e, t, n, l), t.child)
  );
}
function zu(e, t, n, r, l) {
  ...
  if ((Yt(t, l), t.stateNode === null))
    _r(e, t), oa(t, n, r), Ei(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      u = t.memoizedProps;
    o.props = u;
...
function ac(e, t, n, r, l, i, o) {
  ...
  if (((u = (o & e.childLanes) !== 0), ce || u)) {
    ...
    return Lo(), (r = Al(Error(y(421)))), mr(e, t, o, r);
  }
  return l.data === "$?"
    ? ((t.flags |= 128),
      (t.child = e.child),
...
function Va(e) {
  ...
  t !== null && ((e.alternate = null), Va(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null &&
        (delete t[De], delete t[Vn], delete t[yi], delete t[X2], delete t[J2])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Me(e, t, n, r) {
  if (50 < Pn) throw ((Pn = 0), (Di = null), Error(y(185)));
  Gn(e, n, r),
    (!(M & 2) || e !== J) &&
      (e === J && (!(M & 2) && (fl |= n), Y === 4 && be(e, b)),
      pe(e, r),
      n === 1 && M === 0 && !(t.mode & 1) && ((nn = Q() + 500), ul && mt()));
}
function pe(e, t) {
  ...
  if (r === 0)
    ...
    if ((n != null && Ko(n), t === 1))
      e.tag === 0 ? q2(Uu.bind(null, e)) : bs(Uu.bind(null, e)),
        Y2(function () {
          !(M & 6) && mt();
        }),
        (n = null);
...
function Qa(e, t) {
  if (((jr = -1), (Lr = 0), M & 6)) throw Error(y(327));
  var n = e.callbackNode;
  ...
  if (r & 30 || r & e.expiredLanes || t) t = qr(e, r);
    ...
    M |= 2;
    var i = Ka();
    (J !== e || b !== t) && ((Ue = null), (nn = Q() + 500), kt(e, t));
    do
      try {
        wc();
        break;
  ...
  if (t !== 0) {
    if (
      ...
      throw ((n = Zn), kt(e, 0), be(e, r), pe(e, Q()), n);
    if (t === 6) be(e, r);
    else {
      if (
...
function Uu(e) {
  ...
  if (n === 1) throw ((n = Zn), kt(e, 0), be(e, t), pe(e, Q()), n);
...
function qr(e, t) {
  ...
  while (!0);
  if ((ao(), (M = n), (Gr.current = r), Z !== null)) throw Error(y(261));
  return (J = null), (b = 0), Y;
}
function yc() {
  for (; Z !== null; ) Ya(Z);
...
function xc(e, t, n, r) {
  ...
  if (Xr) throw ((Xr = !1), (e = Fi), (Fi = null), e);
  return (
    Jr & 1 && e.tag !== 0 && Gt(),
    (i = e.pendingLanes),
    i & 1 ? (e === Di ? Pn++ : ((Pn = 0), (Di = e))) : (Pn = 0),
    mt(),
    null
  );
}
  ...
  if (tt !== null) {
    ...
    try {
      if (((Se.transition = null), (R = 16 > e ? 16 : e), tt === null))
        ...
        if (((e = tt), (tt = null), (Jr = 0), M & 6)) throw Error(y(331));
        var l = M;
...
Ja = function (e, t, n) {
  ...
  else (ce = !1), H && t.flags & 1048576 && ea(t, Ar, t.index);
  switch (((t.lanes = 0), t.tag)) {
    case 2:
      var r = t.type;
      _r(e, t), (e = t.pendingProps);
      var l = Jt(t, le.current);
      Yt(t, n), (l = yo(null, t, r, e, l, n));
      var i = wo();
      return (
        (t.flags |= 1),
        typeof l == "object" &&
        ...
        l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            Ei(t, r, e, n),
            (t = ji(null, t, r, !0, i, n)))
          : ((t.tag = 0), H && i && io(t), ie(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 &&
          (Ji(t, n | 1), pe(t, Q()), !(M & 6) && ((nn = Q() + 500), mt()));
      }
      break;
    case 13:
      Lt(function () {
...
ys = _o;
ws = Lt;
var zc = { usingClientEntryPoint: !1, Events: [Jn, It, ol, vs, gs, _o] },
  vn = {
...
ye.hydrateRoot = function (e, t, n) {
  ...
  if (
    ...
    (t = e0(t, null, e, 1, n ?? null, l, !1, i, o)),
    (e[Qe] = t.current),
    Hn(e),
    r)
  )
...
var Mc = es.exports,
  Bu = Mc;
(Zl.createRoot = Bu.createRoot), (Zl.hydrateRoot = Bu.hydrateRoot);
const r0 = "./assets/big-shoe1-t-kyWvQp.png",
  Rc = "./assets/big-shoe2-YLWdOy0_.png",
  Oc = "./assets/big-shoe3-E5eZfJ29.png",
  Fc = "./assets/customer1-5wKu_-0p.jpeg",
  Dc = "./assets/customer2-TnkXzQmW.svg",
  Ic =
  ...
  Uc = "./assets/offer-rZN2PQzb.svg",
  Vc = "./assets/shoe4-eEDbLxzM.svg",
  $c = "./assets/shoe5-HfKx76mj.svg",
  Ac = "./assets/shoe6-brpYMALL.svg",
  Bc = "./assets/shoe7-bKiCSFC8.svg",
  Wc = "./assets/shoe8-R_VCZdjg.svg",
  Qc = "./assets/thumbnail-shoe1-cUSdWbnj.svg",
  Zc = "./assets/thumbnail-shoe2-Ep-kp1Hs.svg",
  Kc = "./assets/thumbnail-shoe3-GLE6xauP.svg",
  l0 =
  ...
  l1 = [
    { thumbnail: Qc, bigShoe: r0 },
    { thumbnail: Zc, bigShoe: Rc },
    { thumbnail: Kc, bigShoe: Oc },
  ],
  i1 = [
  ...
  o1 = [
    { imgURL: Vc, name: "Nike Air Jordan-01", price: "$200.20" },
    { imgURL: $c, name: "Nike Air Jordan-10", price: "$210.20" },
    { imgURL: Ac, name: "Nike Air Jordan-100", price: "$220.20" },
  ...
  c1 = [
    { src: Gc, alt: "facebook logo" },
    { src: n1, alt: "twitter logo" },
    { src: Jc, alt: "instagram logo" },
  ],
  f1 = () =>
    p.jsx("header", {
      ...
      children: p.jsxs("nav", {
        ...
        children: [
          ...
          p.jsxs("div", {
            className:
              "flex gap-2 text-lg leading-normal font-medium font-montserrat max-lg:hidden wide:mr-24",
            children: [
              p.jsx("a", { href: "/", children: "Sign in" }),
              p.jsx("span", { children: "/" }),
              p.jsx("a", { href: "/", children: "Explore now" }),
            ],
          }),
          p.jsx("div", {
  ...
  Kn = ({
    ...
    p.jsxs("button", {
      className: `flex justify-center items-center gap-2 px-7 py-4 border font-montserrat text-lg leading-none rounded-full ${
        n ? `${n} ${r} ${l}` : "bg-coral-red text-white border-coral-red"
      } ${i && "w-full"}`,
      children: [
        e,
        t &&
  ...
  d1 = ({ imgURL: e, changeBigShoeImage: t, bigShoeImg: n }) => {
    const r = () => {
  ...
  p1 = () => {
    ...
    return p.jsxs("section", {
      ...
      children: [
        p.jsxs("div", {
          ...
          children: [
            p.jsx("p", {
              ...
              children: "Our Summer Collections",
            }),
            p.jsxs("h1", {
              className:
            ...
            p.jsx(Kn, { label: "Shop now", iconUrl: l0 }),
            p.jsx("div", {
              className:
        ...
        p.jsxs("div", {
          className:
            "relative flex justify-center items-center xl:min-h-screen max-xl:py-40 bg-primary bg-hero bg-center",
          children: [
            p.jsx("img", {
              src: e,
              alt: "shoe collection",
  ...
  m1 = ({ imgURL: e, name: t, price: n }) =>
    p.jsxs("div", {
      ...
      children: [
        ...
        p.jsx("p", {
          className:
            "mt-2 font-semibold font-montserrat text-2xl text-coral-red",
          children: n,
        }),
      ],
    }),
  h1 = () =>
    p.jsxs("section", {
      ...
      children: [
        p.jsxs("div", {
          className: "flex felx-col justify-start gap-5",
          children: [
            p.jsxs("h2", {
              className: "text-4xl font-palanquin font-bold",
              children: [
        ...
        p.jsx("div", {
          className:
            "mt-16 grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 grid-cols-1 sm:gap-4 gap14",
          children: o1.map((e) => p.jsx(m1, { ...e }, e.name)),
        }),
      ],
    }),
  v1 = () =>
  ...
  g1 = ({ imgURL: e, label: t, subtext: n }) =>
    p.jsxs("div", {
      ...
      children: [
        p.jsx("div", {
          className:
            "w-11 h-11 flex justify-center items-center bg-coral-red rounded-full",
  ...
  y1 = () =>
    p.jsx("section", {
      ...
      children: u1.map((e) => p.jsx(g1, { ...e }, e.label)),
    }),
  w1 = () =>
    p.jsxs("section", {
      className:
        "flex justify-between items-center max-xl:flex-col gap-10 max-container",
      children: [
        p.jsxs("div", {
          className: "flex flex-1 flex-col",
          children: [
            ...
            p.jsxs("div", {
              ...
              children: [
                p.jsx(Kn, { label: "View details", iconURL: l0 }),
                p.jsx(Kn, {
                  label: "Learn more",
  ...
  x1 = ({ imgURL: e, customerName: t, rating: n, feedback: r }) =>
    p.jsxs("div", {
  ...
  C1 = () =>
    p.jsxs("section", {
      ...
      children: [
        ...
        p.jsx("p", {
          className: "mt-4 max-w-lg info-text m-auto text-center",
          children:
              ...
              p.jsxs(
                "div",
                {
                  children: [
                    p.jsx("h4", {
                      className:
                        "font-montserrat text-2xl leading-normal font-medium mb-6 text-white",
                      children: e.title,
                    }),
                    p.jsx("ul", {
                      children: e.links.map((t) =>
                        p.jsx(
                          ...
                          {
                            className:
                              "mt-3 font-montserrat text-base leading-normal text-white-400 hover:text-slate-gray",
                            children: p.jsx("a", {
                              href: t.link,
                              children: t.name,
                            }),
  ...
  E1 = () =>
    p.jsxs("main", {
      ...
      children: [
        ...
        p.jsx("section", { className: "padding", children: p.jsx(v1, {}) }),
        p.jsx("section", {
          className: "padding-x py-10",
          children: p.jsx(y1, {}),
        }),
        p.jsx("section", { className: "padding", children: p.jsx(w1, {}) }),
        p.jsx("section", {
...
Zl.createRoot(document.getElementById("root")).render(
  p.jsx(k0.StrictMode, { children: p.jsx(E1, {}) })
);
